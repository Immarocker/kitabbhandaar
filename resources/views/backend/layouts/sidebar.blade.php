<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Authors -->
    <a class="sidebar-authors d-flex align-items-center justify-content-center" href="{{route('admin')}}">
      <div class="sidebar-authors-icon rotate-n-15">
        <i class="fas fa-laugh-wink"></i>
      </div>
      <div class="sidebar-authors-text mx-3">Admin</div>
    </a>
